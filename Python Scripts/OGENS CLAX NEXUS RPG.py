...
# Helper function for "No Companions Remain" game-over screen
def end_game_no_companions():
    os.system("cls")
    print(Fore.YELLOW + "--------------------------------------" + Style.RESET_ALL)
    print(Fore.YELLOW + "OGENS CLAX NEXUS - D5+D5" + Style.RESET_ALL)
    print(Fore.YELLOW + "--------------------------------------" + Style.RESET_ALL)
    print(Fore.YELLOW + "\n   //===\\\\" + Style.RESET_ALL)
    print(Fore.YELLOW + "  // RIP \\\\" + Style.RESET_ALL)
    print(Fore.YELLOW + " //_______\\\\" + Style.RESET_ALL)
    print(Fore.YELLOW + " |  ***  |" + Style.RESET_ALL)
    print(Fore.YELLOW + " |_______|" + Style.RESET_ALL)
    print(Fore.YELLOW + "\nNO COMPANIONS REMAIN! THE LABYRINTH IS TOO PERILOUS..." + Style.RESET_ALL)
    ...
    with open("GameLog.txt", "a") as f:
        f.write(f"{now.strftime('%m/%d/%Y %H:%M')} - Loss (No companions remain)\n")
...
def path_outcomes(path, adjusted_grid):
    ...
    # Apply +10 health boost for fallen companions on positive outcomes
    was_fallen = current_companion["name"] in fallen_companions
    if was_fallen and is_positive_outcome(changes):
        changes["comp_health"] += 10  # Add +10 health for fallen companion
...
def main():
 ...
 |_______| 
    ...
    print(Fore.YELLOW + "\n\n        Press Enter to enter" + Style.RESET_ALL)
    print(Fore.YELLOW + "    Ogens Clax Nexus Labyrinth..." + Style.RESET_ALL)
    input()
...
"""
            ...
            print(Fore.YELLOW + "OGENS CLAX NEXUS - D5+D5" + Style.RESET_ALL)
            print(Fore.YELLOW + "--------------------------------------" + Style.RESET_ALL)
            print(Fore.YELLOW + f"\n{'TRAVERSING THE LEFT TUNNEL...' if path == 1 else 'TRAVERSING THE RIGHT TUNNEL...' if path == 2 else 'CLIMBING THE HIDDEN STAIRS...' if path == 3 else 'ENTERING THE CRYSTAL CAVERN...'}" + Style.RESET_ALL)
            print(Fore.YELLOW + path_displays[path] + Style.RESET_ALL)
            companion_name = companions[secrets.randbelow(len(companions))]
            ...
            print(Fore.YELLOW + "OGENS CLAX NEXUS - D5+D5" + Style.RESET_ALL)
            print(Fore.YELLOW + "--------------------------------------" + Style.RESET_ALL)
            print(Fore.YELLOW + "\nLEAVING THE LABYRINTH..." + Style.RESET_ALL)
            print(Fore.YELLOW + f"\nFinal Score: {player['score']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Health: {player['health']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Artifacts: {player['artifacts']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Relics: {player['relics']}" + Style.RESET_ALL)
        ...
        if player["health"] <= 0:
            ...
            print(Fore.YELLOW + " |  ***  |" + Style.RESET_ALL)
            print(Fore.YELLOW + " |_______|" + Style.RESET_ALL)
            print(Fore.YELLOW + "\nTHE LABYRINTH CLAIMS YOU..." + Style.RESET_ALL)
            print(Fore.YELLOW + f"\nFinal Score: {player['score']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Health: {player['health']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Artifacts: {player['artifacts']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Relics: {player['relics']}" + Style.RESET_ALL)
        ...
        if player["score"] >= 6000 and player["artifacts"] >= 300 and player["relics"] >= 50:
            ...
            print(Fore.YELLOW + "  // *** \\\\" + Style.RESET_ALL)
            print(Fore.YELLOW + " //_______\\\\" + Style.RESET_ALL)
            print(Fore.YELLOW + " |  WIN  |" + Style.RESET_ALL)
            print(Fore.YELLOW + " |_______|" + Style.RESET_ALL)
            print(Fore.YELLOW + "\nVICTORY OVER THE LABYRINTH..." + Style.RESET_ALL)
            print(Fore.YELLOW + f"\nFinal Score: {player['score']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Health: {player['health']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Artifacts: {player['artifacts']}" + Style.RESET_ALL)
            print(Fore.YELLOW + f"Final Relics: {player['relics']}" + Style.RESET_ALL)
