# OGENS Crypto Surge & Rune Pulse NEXUS RPG - D5+D10 - D10+D10
...
Embark on an epic journey through OGENS Crypto Surge and Rune Pulse Nexus, two thrilling command-line RPGs set in electrifying worlds of cyberpunk chaos and mystic realms. In OGENS Crypto Surge (D10+D10), dive into a neon-lit cyberpunk dystopia where hackers and rogue AIs battle for dominance, navigating treacherous digital grids to collect crypto chips and quantum cores, surviving deadly traps, recruiting companions, and leveling up to conquer the Crypto Nexus. In Rune Pulse Nexus (D5+D10), explore a mystical realm of ancient sorcery, gathering sacred runes and arcane crystals, braving enchanted traps, recruiting allies, and leveling up to master the Rune Nexus. Each playthrough is unique, driven by randomized characters and branching events determined by dice rolls. OGENS Crypto Surge rolls two ten-sided dice (1–10), mapping to outcomes 1–100 for each cyberpunk path. Rune Pulse Nexus rolls a five-sided die (1–5) and a ten-sided die (1–10), mapping to outcomes 1–50 for each mystical path. Dive into these dice-driven worlds and forge your legend in realms of neon circuits and ancient magic!
...
3. Double click `OGENS CRYPTO SURGE & RUNE PULSE RPG.exe` to run the game.
