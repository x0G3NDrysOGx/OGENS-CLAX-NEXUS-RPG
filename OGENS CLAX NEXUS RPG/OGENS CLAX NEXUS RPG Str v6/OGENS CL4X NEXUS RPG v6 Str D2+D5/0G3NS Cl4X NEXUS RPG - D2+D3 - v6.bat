...
rem Path 1: Left Tunnel (Grid: 1-6, 3 negative outcomes, no relics)
if "!choice!"=="1" (
    if !adjusted_grid! == 1 (set "result=A shimmering idol glints in the shadows" & set /a score_change=8 + !level! & set /a artifact_change=1 & set /a xp_change=10 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    ...
    if !adjusted_grid! == 3 (set "result=A cave-in traps you briefly" & set /a comp_health_change=-10 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-10 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 4 (set "result=A venomous scorpion stings" & set /a comp_health_change=-15 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-15 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 5 (set "result=Ancient roots mend your wounds" & set /a comp_health_change=2 & set /a score_change=3 + !level! & set /a xp_change=5 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 6 (set "result=A cryptic mural unveils its wisdom" & set /a score_change=6 + !level! & set /a artifact_change=1 & set /a xp_change=8 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
)

rem Path 2: Right Tunnel (Grid: 1-6, 3 negative outcomes, relic on outcome 1)
if "!choice!"=="2" (
    if !adjusted_grid! == 1 (set "result=A radiant sigil flares with light" & set /a score_change=7 + !level! & set /a artifact_change=1 & set /a relic_change=1 & set /a xp_change=10 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    ...
    if !adjusted_grid! == 3 (set "result=A fiery trap scorches you" & set /a comp_health_change=-12 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-12 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 4 (set "result=A sudden tremor shakes the tunnel" & set /a comp_health_change=-15 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-15 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 5 (set "result=A faint talisman sparkles softly" & set /a charm_change=1 & set /a xp_change=5 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 6 (set "result=Etched runes share their knowledge" & set /a score_change=6 + !level! & set /a artifact_change=1 & set /a xp_change=8 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
)

rem Path 3: Hidden Stairs (Grid: 1-6, 3 negative outcomes, no relics)
if "!choice!"=="3" (
    if !adjusted_grid! == 1 (set "result=A dawn gem radiates warmth" & set /a score_change=6 + !level! & set /a artifact_change=1 & set /a xp_change=10 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    ...
    if !adjusted_grid! == 3 (set "result=Collapsing stairs bruise you" & set /a comp_health_change=-10 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-10 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 4 (set "result=A spectral curse saps vitality" & set /a comp_health_change=-15 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-15 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 5 (set "result=A blessed elixir lies in the rubble" & set /a potion_change=1 & set /a xp_change=5 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 6 (set "result=A mystic key gleams in the dust" & set /a key_change=1 & set /a xp_change=5 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
)

rem Path 4: Crystal Cavern (Grid: 1-6, 3 negative outcomes, relic on outcome 1)
if "!choice!"=="4" (
    if !adjusted_grid! == 1 (set "result=A luminous jewel dazzles the eye" & set /a score_change=8 + !level! & set /a artifact_change=1 & set /a relic_change=1 & set /a xp_change=10 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    ...
    if !adjusted_grid! == 3 (set "result=A crystal spire collapses" & set /a comp_health_change=-10 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-10 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 4 (set "result=A crystal hawk dives" & set /a comp_health_change=-15 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-15 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 5 (set "result=A radiant potion shines in a crevice" & set /a potion_change=1 & set /a xp_change=5 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
    if !adjusted_grid! == 6 (set "result=A sacred key sparkles in the glow" & set /a key_change=1 & set /a xp_change=5 & set /a comp_health_change=2 & set /a player_health_change=2 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
)
...
if !xp! geq !xp_needed! (
    ...
    set /a max_health+=10
    set /a health+=3
    set /a levelup_health_change=3
    if !health! gtr !max_health! set /a health=!max_health!
    set /a xp-=!xp_needed!
    set /a xp_needed=!level! * 50
    if !healing_potion! lss 3 (
        set /a healing_potion+=1
        echo You've reached Level !level!^^! Max Health increased to !max_health!, Health +3, Score gains increased, and you gained a Healing Potion^^!
    ) else (
        echo You've reached Level !level!^^! Max Health increased to !max_health!, Health +3, Score gains increased^^!
    )
    echo.
    set "leveled_up=1"
)
