...
if "!choice!"=="4" (
    ...
    if !adjusted_grid! == 2 (set "result=A radiant potion shines in a crevice" & set /a potion_change=1 & set /a xp_change=6 & set /a comp_health_change=3 & set /a player_health_change=3 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
