...
def check_paylines(reels, bet):
    ...
    paylines = [
        ...
        [(0, 4), (1, 3), (2, 2), (3, 1), (4, 0)],  # Diagonal TR-BL
        [(0, 0), (1, 1), (2, 2), (3, 1), (4, 0)],  # Zigzag 1
        [(0, 4), (1, 3), (2, 2), (3, 3), (4, 4)],  # Zigzag 2
        [(0, 0), (1, 2), (2, 4), (3, 2), (4, 0)],  # Zigzag 3
        [(0, 4), (1, 2), (2, 0), (3, 2), (4, 4)]   # Zigzag 4
    ]
...
class SlotMachineGUI:
    def __init__(self, root):
        ...
        # Reel labels (5x5 grid) - Non-bold font, size 18
