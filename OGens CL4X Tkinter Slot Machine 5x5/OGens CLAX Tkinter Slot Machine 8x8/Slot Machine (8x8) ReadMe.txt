...
For paylines with fewer than 8 symbols, the multiplier is halved (integer division) for symbols 🎮, 🖱️, 🎲, and 🖼️; otherwise, the full multiplier applies.
**Example**: If your bet is 10 coins and you hit an 8-symbol payline with 🎮 symbols, you win `floor(10 × 1) = 10 coins`. For a 5-symbol payline with 🎮, you win `floor(10 × (1 // 2)) = 0 coins`. For a 5-symbol payline with 💾, you win `floor(10 × (4 // 2)) = 20 coins`.
