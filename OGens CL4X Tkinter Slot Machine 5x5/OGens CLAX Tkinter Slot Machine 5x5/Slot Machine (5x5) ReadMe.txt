...
- **Extra Spins**: Can be used instead of regular spins, costing no coins but not contributing to the jackpot. Purchased via the store.
...
- **Free Spins** (triggered by five 💎):
  ...
  - Spin 2–5: No wins. Final: 20 coins added to balance (now 190), 50 credits added (now 130).
- **Store Purchase**: Spend 100 credits on Balance Boost, adding 100 coins (balance: 290, credits: 30).
