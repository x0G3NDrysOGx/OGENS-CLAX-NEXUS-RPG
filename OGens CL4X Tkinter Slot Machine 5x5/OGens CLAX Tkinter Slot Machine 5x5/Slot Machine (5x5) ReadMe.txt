...
- **Extra Spins**: Can be used instead of regular spins, costing no coins but not contributing to the jackpot. Purchased via the store or awarded via Mystery Prize.
...
**Example**: If your bet is 10 coins and you hit a 5-symbol payline with 🍒 symbols, you win `floor(10 × 2) = 20 coins`. For a 3-symbol payline, you win `floor(10 × (2 // 2)) = 10 coins`.  
...
These credits are added to your total credits, which can be used to purchase items in the store (e.g., extra spins, balance boosts, or the Mystery Prize).

**Example**: If you hit two paylines in a single spin (e.g., one 🍒 and one ⭐), you might earn `floor(10 × 2) = 20 coins` (🍒) + `floor(10 × 6) = 60 coins` (⭐) = 80 coins, plus, for example, 50 credits for the 🍒 payline and 30 credits for the ⭐ payline, totaling 80 credits.
...
- **Regular Spin**:
  ...
  - Hits two paylines (🍒: `floor(10 × 2) = 20 coins`, ⭐: `floor(10 × 6) = 60 coins`) and earns 50 + 30 = 80 credits.
  - Total: 80 coins + 80 credits added (balance: 170, credits: 80).
  - Jackpot increases by 10 (to 1010).
- **Mystery Prize Purchase**:
  - Spend 75 credits (credits: 5).
  - Random outcome: Awards 80 coins (balance: 250), or 60 credits (credits: 65), or 1 extra spin (extra spins: 1).
- **Free Spins** (triggered by five 💎):
  - 5 spins, each checking paylines with 10-coin bet.
  - Spin 1: Hits 🍒 payline (`floor(10 × 2) = 20 coins`, 50 credits). Total so far: 20 coins, 50 credits.
  - Spin 2–5: No wins. Final: 20 coins added to balance (now 270), 50 credits added (now 55 or 115, depending on Mystery Prize).
- **Store Purchase**: Spend 100 credits on Balance Boost, adding 100 coins (balance: 370, credits: 15 or 55).

This README provides a complete overview of the 5x5 slot machine game, covering payouts, extra credits, the Mystery Prize, and all mechanics for regular and free spins, ensuring players understand how to play and what to expect from wins.