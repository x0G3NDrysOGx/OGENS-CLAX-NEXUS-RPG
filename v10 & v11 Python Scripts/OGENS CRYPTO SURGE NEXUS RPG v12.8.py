...
def path_outcomes(path, outcome):
    ...
    outcomes_neon_underdistrict = {
        ...
        2: ("Found a Nano Patch in an alley!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        ...
        6: ("Dodged a trap, restored vitality!", {"player_health": 4, "comp_health": 4, "xp": 10, "credits": 10}),
        7: ("Picked up a Data Drive from debris!", {"data_drive": 1, "xp": 8, "credits": 10}),
        8: ("Quick hack paid off with credits!", {"credits": 25, "xp": 10}),
        9: ("Gang scuffle left you bruised!", {"player_health": -5, "comp_health": -5, "xp": 3}),
        10: ("Found a Quantum Core in a dumpster!", {"quantum_core": 1, "xp": 10, "credits": 10}),
        11: ("Struck a deal, gained crypto chips!", {"crypto_chips": 3, "xp": 10, "credits": 10}),
        12: ("Street medkit patched you up!", {"player_health": 5, "comp_health": 5, "xp": 8, "credits": 10}),
        13: ("Outran a drone, gained experience!", {"xp": 12, "credits": 10}),
        14: ("Courier job brought in credits!", {"credits": 25, "xp": 10}),
        15: ("Found a hidden Data Drive!", {"data_drive": 1, "xp": 8, "credits": 10}),
        16: ("Hacked a vendor, scored points!", {"score": secrets.randbelow(10) + 15, "xp": 10, "credits": 10}),  # 15-24
        17: ("Unearthed a Neon Key in the shadows!", {"neon_key": 1, "xp": 8, "credits": 10}),
        18: ("Gang ambush caught you off guard!", {"player_health": -6, "comp_health": -6, "xp": 3}),
        ...
        23: ("Slipped past a patrol, gained XP!", {"xp": 15, "credits": 10}),
        24: ("Traded for credits in the market!", {"credits": 40, "xp": 10}),
        25: ("Picked up a Neon Key in the chaos!", {"neon_key": 1, "xp": 8, "credits": 10}),
        26: ("Hacked a terminal, boosted score!", {"score": secrets.randbelow(10) + 20, "xp": 10, "credits": 10}),  # 20-29
        27: ("Gang attack left you battered!", {"player_health": -7, "comp_health": -7, "xp": 3}),
        28: ("Heist paid off with credits!", {"credits": 45, "xp": 10}),
        29: ("Found crypto chips in a stash!", {"crypto_chips": 4, "xp": 10, "credits": 10}),
        ...
        35: ("Gang fight took a toll!", {"player_health": -8, "comp_health": -8, "xp": 3}),
        ...
        39: ("Dodged a trap, health restored!", {"player_health": 5, "comp_health": 5, "xp": 8, "credits": 10}),
        40: ("Overcame a challenge, gained XP!", {"xp": 18, "credits": 15}),
        41: ("Traded for a stack of credits!", {"credits": 55, "xp": 10}),
        42: ("Scored a Quantum Core in a raid!", {"quantum_core": 1, "xp": 10, "credits": 10}),
        43: ("Hacked a drone, boosted score!", {"score": secrets.randbelow(10) + 25, "xp": 10, "credits": 10}),  # 25-34
        44: ("Found a Neon Key in a dump!", {"neon_key": 1, "xp": 8, "credits": 10}),
        45: ("Gang ambush hit hard!", {"player_health": -9, "comp_health": -9, "xp": 3}),
        46: ("Hacked a system, earned credits!", {"credits": 60, "xp": 10}),
        47: ("Won a fight, gained crypto chips!", {"crypto_chips": 5, "xp": 10, "credits": 10}),
        48: ("Found a Nano Patch in a crate!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        49: ("Dodged a trap, health restored!", {"player_health": 6, "comp_health": 6, "xp": 8, "credits": 10}),
        50: ("Crypto Surge found! (Doubles credits for 2 events)", {"crypto_surge": 1, "credits": -10, "xp": 10}),
        51: ("Street medkit patched you up!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        52: ("Thief swiped your credits!", {"credits": -10, "xp": 3}),
        53: ("Companion caught in a fight!", {"comp_health": -10, "xp": 3}),
        54: ("Failed hack cost you credits!", {"credits": -8, "xp": 3}),
        55: ("Gang trap hit you!", {"player_health": -10, "comp_health": -10, "xp": 3}),
        56: ("Bad deal cost you credits!", {"credits": -12, "xp": 3}),
        57: ("Companion hurt in a brawl!", {"comp_health": -11, "xp": 3}),
        58: ("Grid virus zapped you!", {"player_health": -11, "comp_health": -11, "xp": 3}),
        59: ("Lost crypto chips to a thief!", {"crypto_chips": -1, "xp": 3}),
        60: ("Ambushed, took a beating!", {"player_health": -12, "comp_health": -12, "xp": 3}),
        61: ("Scammed, lost credits!", {"credits": -15, "xp": 3}),
        62: ("Companion injured in a fight!", {"comp_health": -13, "xp": 3}),
        63: ("Hack attempt failed!", {"player_health": -13, "comp_health": -13, "xp": 3}),
        64: ("Credits stolen in a heist!", {"credits": -15, "xp": 3}),
        65: ("Companion hurt in an ambush!", {"comp_health": -14, "xp": 3}),
        66: ("Grid interference drained vitality!", {"player_health": -14, "comp_health": -14, "xp": 3}),
        67: ("Found a hidden medkit!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        68: ("Gang took your credits!", {"credits": -18, "xp": 3}),
        69: ("Companion severely injured!", {"comp_health": -15, "xp": 3}),
        70: ("Deal gone wrong, lost credits!", {"credits": -20, "xp": 3}),
        71: ("Gang attack hit hard!", {"player_health": -15, "comp_health": -15, "xp": 3}),
        72: ("Trap cost you credits!", {"credits": -12, "xp": 3}),
        73: ("Companion took a bad hit!", {"comp_health": -16, "xp": 3}),
        74: ("Grid virus spread, damage taken!", {"player_health": -16, "comp_health": -16, "xp": 3}),
        75: ("Heist wiped out your credits!", {"credits": -22, "xp": 3}),
        76: ("Found a street medkit!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        77: ("Severe gang assault!", {"player_health": -17, "comp_health": -17, "xp": 3}),
        78: ("Lost credits in a scam!", {"credits": -15, "xp": 3}),
        79: ("Companion critically wounded!", {"comp_health": -18, "xp": 3}),
        80: ("Ambush took down companion!", {"comp_health": -19, "xp": 3}),
        81: ("Gang assault hit hard!", {"player_health": -18, "comp_health": -18, "xp": 3}),
        82: ("Fight drained credits!", {"credits": -20, "xp": 3}),
        83: ("Companion hurt badly!", {"comp_health": -20, "xp": 3}),
        84: ("Grid virus outbreak, damage taken!", {"player_health": -19, "comp_health": -19, "xp": 3}),
        85: ("Scam cost you credits!", {"credits": -18, "xp": 3}),
        86: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        87: ("Major gang attack!", {"player_health": -20, "comp_health": -20, "xp": 3}),
        88: ("Credits stolen in a heist!", {"credits": -25, "xp": 3}),
        89: ("Companion in critical condition!", {"comp_health": -21, "xp": 3}),
        90: ("Grid virus surge, damage taken!", {"player_health": -21, "comp_health": -21, "xp": 3}),
        91: ("Gang wipeout, losses taken!", {"player_health": -22, "comp_health": -22, "xp": 3}),
        92: ("Lost credits and health!", {"credits": -20, "player_health": -23, "comp_health": -23, "xp": 3}),
        93: ("Companion badly injured!", {"comp_health": -24, "xp": 3}),
        94: ("Grid collapse, vitality drained!", {"player_health": -24, "comp_health": -24, "xp": 3}),
        95: ("Gang hit hard!", {"player_health": -25, "comp_health": -25, "xp": 3}),
        96: ("Found a cyber medkit!", {"player_health": 12, "comp_health": 12, "xp": 8, "credits": 15}),
        97: ("Companion critically wounded!", {"comp_health": -26, "xp": 3}),
        98: ("Grid overload, damage taken!", {"player_health": -26, "comp_health": -26, "xp": 3}),
        99: ("Gang attack, critical hit!", {"player_health": -27, "comp_health": -27, "xp": 3}),
        100: ("Total grid failure!", {"credits": -20, "player_health": -30, "comp_health": -30, "xp": 3})
    }
    ...
    outcomes_corporate_skyspire = {
        ...
        6: ("Evaded drones, restored vitality!", {"player_health": 5, "comp_health": 5, "xp": 10, "credits": 10}),
        7: ("Snagged a Data Drive from a desk!", {"data_drive": 1, "xp": 8, "credits": 10}),
        8: ("Quick hack netted credits!", {"credits": 30, "xp": 10}),
        9: ("Security bot zapped you!", {"player_health": -6, "comp_health": -6, "xp": 3}),
        10: ("Found a Quantum Core in a lab!", {"quantum_core": 1, "xp": 10, "credits": 10}),
        11: ("Deal brought crypto chips!", {"crypto_chips": 3, "xp": 10, "credits": 10}),
        12: ("Corporate medkit restored health!", {"player_health": 6, "comp_health": 6, "xp": 8, "credits": 10}),
        ...
        18: ("Security lockdown hurt you!", {"player_health": -7, "comp_health": -7, "xp": 3}),
        ...
        23: ("Evaded a trap, gained XP!", {"xp": 14, "credits": 10}),
        ...
        39: ("Dodged a trap, health restored!", {"player_health": 6, "comp_health": 6, "xp": 8, "credits": 10}),
        40: ("Overcame a challenge, gained XP!", {"xp": 18, "credits": 15}),
        ...
        45: ("Security system zapped you!", {"player_health": -10, "comp_health": -10, "xp": 3}),
        46: ("Hacked a system, earned credits!", {"credits": 65, "xp": 10}),
        47: ("Won a deal, gained crypto chips!", {"crypto_chips": 5, "xp": 10, "credits": 10}),
        48: ("Found a Nano Patch in a crate!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        49: ("Dodged a trap, health restored!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        50: ("Crypto Surge in a safe! (Doubles credits for 2 events)", {"crypto_surge": 1, "credits": -12, "xp": 10}),
        51: ("Corporate medkit patched you up!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        52: ("Lost credits to a corporate scam!", {"credits": -12, "xp": 3}),
        53: ("Companion caught in a trap!", {"comp_health": -11, "xp": 3}),
        54: ("Failed hack cost credits!", {"credits": -10, "xp": 3}),
        55: ("Security lockdown hit hard!", {"player_health": -11, "comp_health": -11, "xp": 3}),
        56: ("Bad deal cost credits!", {"credits": -15, "xp": 3}),
        57: ("Companion badly hurt!", {"comp_health": -12, "xp": 3}),
        58: ("System virus zapped you!", {"player_health": -12, "comp_health": -12, "xp": 3}),
        59: ("Lost crypto chips to a hack!", {"crypto_chips": -1, "xp": 3}),
        60: ("Ambushed by security!", {"player_health": -13, "comp_health": -13, "xp": 3}),
        61: ("Scammed, lost credits!", {"credits": -17, "xp": 3}),
        62: ("Companion injured in a fight!", {"comp_health": -14, "xp": 3}),
        63: ("Hack failed, took damage!", {"player_health": -14, "comp_health": -14, "xp": 3}),
        64: ("Credits stolen in a heist!", {"credits": -15, "xp": 3}),
        65: ("Companion hurt in a trap!", {"comp_health": -15, "xp": 3}),
        66: ("System surge drained vitality!", {"player_health": -15, "comp_health": -15, "xp": 3}),
        67: ("Found a corporate medkit!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        68: ("Security took your credits!", {"credits": -18, "xp": 3}),
        69: ("Companion severely injured!", {"comp_health": -16, "xp": 3}),
        70: ("Deal gone wrong, lost credits!", {"credits": -20, "xp": 3}),
        71: ("Security assault hit hard!", {"player_health": -16, "comp_health": -16, "xp": 3}),
        72: ("Trap cost you credits!", {"credits": -12, "xp": 3}),
        73: ("Companion took a bad hit!", {"comp_health": -17, "xp": 3}),
        74: ("System virus, damage taken!", {"player_health": -17, "comp_health": -17, "xp": 3}),
        75: ("Heist wiped out credits!", {"credits": -22, "xp": 3}),
        76: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        77: ("Severe security assault!", {"player_health": -18, "comp_health": -18, "xp": 3}),
        78: ("Lost credits in a scam!", {"credits": -15, "xp": 3}),
        79: ("Companion critically wounded!", {"comp_health": -19, "xp": 3}),
        80: ("Security took down companion!", {"comp_health": -20, "xp": 3}),
        81: ("Security assault hit hard!", {"player_health": -19, "comp_health": -19, "xp": 3}),
        82: ("Fight drained credits!", {"credits": -20, "xp": 3}),
        83: ("Companion hurt badly!", {"comp_health": -21, "xp": 3}),
        84: ("System outage, damage taken!", {"player_health": -20, "comp_health": -20, "xp": 3}),
        85: ("Scam cost you credits!", {"credits": -18, "xp": 3}),
        86: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        87: ("Major security attack!", {"player_health": -21, "comp_health": -21, "xp": 3}),
        88: ("Credits stolen in a heist!", {"credits": -25, "xp": 3}),
        89: ("Companion in critical condition!", {"comp_health": -22, "xp": 3}),
        90: ("System surge, damage taken!", {"player_health": -22, "comp_health": -22, "xp": 3}),
        91: ("Security wipeout!", {"player_health": -23, "comp_health": -23, "xp": 3}),
        92: ("Lost credits and health!", {"credits": -20, "player_health": -24, "comp_health": -24, "xp": 3}),
        93: ("Companion badly injured!", {"comp_health": -25, "xp": 3}),
        94: ("System collapse!", {"player_health": -24, "comp_health": -24, "xp": 3}),
        95: ("Security hit hard!", {"player_health": -25, "comp_health": -25, "xp": 3}),
        96: ("Found a corporate medkit!", {"player_health": 12, "comp_health": 12, "xp": 8, "credits": 15}),
        97: ("Companion critically wounded!", {"comp_health": -26, "xp": 3}),
        98: ("System overload!", {"player_health": -26, "comp_health": -26, "xp": 3}),
        99: ("Security attack, critical hit!", {"player_health": -27, "comp_health": -27, "xp": 3}),
        100: ("Total system failure!", {"credits": -20, "player_health": -30, "comp_health": -30, "xp": 3})
    }
    ...
    outcomes_data_vault = {
        ...
        5: ("Found a Neon Key in a vault!", {"neon_key": 1, "xp": 8, "credits": 10}),
        6: ("Evaded a virus, restored vitality!", {"player_health": 5, "comp_health": 5, "xp": 10, "credits": 10}),
        7: ("Snagged a Data Drive from a node!", {"data_drive": 1, "xp": 8, "credits": 10}),
        8: ("Quick hack netted credits!", {"credits": 35, "xp": 10}),
        9: ("Virus zapped you!", {"player_health": -7, "comp_health": -7, "xp": 3}),
        10: ("Found a Quantum Core in a server!", {"quantum_core": 1, "xp": 10, "credits": 10}),
        11: ("Hacked a node, got crypto chips!", {"crypto_chips": 4, "xp": 10, "credits": 10}),
        12: ("Server medkit restored health!", {"player_health": 6, "comp_health": 6, "xp": 8, "credits": 10}),
        13: ("Outsmarted AI, gained XP!", {"xp": 14, "credits": 10}),
        14: ("Job paid off with credits!", {"credits": 35, "xp": 10}),
        15: ("Found a hidden Data Drive!", {"data_drive": 1, "xp": 8, "credits": 10}),
        16: ("Hacked a server, scored points!", {"score": secrets.randbelow(10) + 25, "xp": 10, "credits": 10}),  # 25-34
        17: ("Found a Neon Key in a vault!", {"neon_key": 1, "xp": 8, "credits": 10}),
        18: ("Firewall hit you hard!", {"player_health": -8, "comp_health": -8, "xp": 3}),
        ...
        23: ("Evaded a virus, gained XP!", {"xp": 15, "credits": 10}),
        24: ("Traded for credits in a node!", {"credits": 50, "xp": 10}),
        25: ("Found a Neon Key in a vault!", {"neon_key": 1, "xp": 8, "credits": 10}),
        26: ("Hacked a mainframe, big score!", {"score": secrets.randbelow(10) + 30, "xp": 10, "credits": 10}),  # 30-39
        27: ("Virus attack hit hard!", {"player_health": -9, "comp_health": -9, "xp": 3}),
        28: ("Data heist paid well!", {"credits": 55, "xp": 10}),
        29: ("Found crypto chips in a node!", {"crypto_chips": 5, "xp": 10, "credits": 10}),
        ...
        35: ("Firewall trap hit hard!", {"player_health": -10, "comp_health": -10, "xp": 3}),
        36: ("Hacked a system, scored big!", {"score": secrets.randbelow(10) + 30, "xp": 10, "credits": 10}),  # 30-39
        37: ("Deal netted crypto chips!", {"crypto_chips": 5, "xp": 10, "credits": 10}),
        38: ("Found a Nano Patch in a node!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        39: ("Dodged a virus, health restored!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        40: ("Overcame a challenge, gained XP!", {"xp": 20, "credits": 15}),
        41: ("Traded for credits in a vault!", {"credits": 65, "xp": 10}),
        42: ("Found a Quantum Core in a vault!", {"quantum_core": 1, "xp": 10, "credits": 10}),
        43: ("Hacked a drone, big score!", {"score": secrets.randbelow(10) + 35, "xp": 10, "credits": 10}),  # 35-44
        44: ("Found a Neon Key in a server!", {"neon_key": 1, "xp": 8, "credits": 10}),
        45: ("Virus surge hit hard!", {"player_health": -11, "comp_health": -11, "xp": 3}),
        46: ("Hacked a system, earned credits!", {"credits": 70, "xp": 10}),
        47: ("Won a heist, gained crypto chips!", {"crypto_chips": 6, "xp": 10, "credits": 10}),
        48: ("Found a Nano Patch in a crate!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        49: ("Dodged a trap, health restored!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        50: ("Crypto Surge found! (Doubles credits for 2 events)", {"crypto_surge": 1, "credits": -15, "xp": 10}),
        51: ("Server medkit patched you up!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        52: ("Lost credits to a hack!", {"credits": -12, "xp": 3}),
        53: ("Companion caught in a virus!", {"comp_health": -12, "xp": 3}),
        54: ("Failed hack cost credits!", {"credits": -10, "xp": 3}),
        55: ("Firewall hit you hard!", {"player_health": -12, "comp_health": -12, "xp": 3}),
        56: ("Bad deal cost credits!", {"credits": -15, "xp": 3}),
        57: ("Companion badly hurt!", {"comp_health": -13, "xp": 3}),
        58: ("System virus zapped you!", {"player_health": -13, "comp_health": -13, "xp": 3}),
        59: ("Lost crypto chips to a hack!", {"crypto_chips": -1, "xp": 3}),
        60: ("Ambushed by security!", {"player_health": -14, "comp_health": -14, "xp": 3}),
        61: ("Scammed, lost credits!", {"credits": -17, "xp": 3}),
        62: ("Companion injured in a trap!", {"comp_health": -15, "xp": 3}),
        63: ("Hack failed, took damage!", {"player_health": -15, "comp_health": -15, "xp": 3}),
        64: ("Credits stolen in a heist!", {"credits": -15, "xp": 3}),
        65: ("Companion hurt in a virus!", {"comp_health": -16, "xp": 3}),
        66: ("System surge drained vitality!", {"player_health": -16, "comp_health": -16, "xp": 3}),
        67: ("Found a hidden medkit!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        68: ("Security took your credits!", {"credits": -18, "xp": 3}),
        69: ("Companion severely injured!", {"comp_health": -17, "xp": 3}),
        70: ("Deal gone wrong, lost credits!", {"credits": -20, "xp": 3}),
        71: ("Security assault hit hard!", {"player_health": -17, "comp_health": -17, "xp": 3}),
        72: ("Trap cost you credits!", {"credits": -12, "xp": 3}),
        73: ("Companion took a bad hit!", {"comp_health": -18, "xp": 3}),
        74: ("System virus, damage taken!", {"player_health": -18, "comp_health": -18, "xp": 3}),
        75: ("Heist wiped out credits!", {"credits": -22, "xp": 3}),
        76: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        77: ("Severe security assault!", {"player_health": -19, "comp_health": -19, "xp": 3}),
        78: ("Lost credits in a scam!", {"credits": -15, "xp": 3}),
        79: ("Companion critically wounded!", {"comp_health": -20, "xp": 3}),
        80: ("Security took down companion!", {"comp_health": -21, "xp": 3}),
        81: ("Security assault hit hard!", {"player_health": -20, "comp_health": -20, "xp": 3}),
        82: ("Fight drained credits!", {"credits": -20, "xp": 3}),
        83: ("Companion hurt badly!", {"comp_health": -22, "xp": 3}),
        84: ("System outage, damage taken!", {"player_health": -21, "comp_health": -21, "xp": 3}),
        85: ("Scam cost you credits!", {"credits": -18, "xp": 3}),
        86: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        87: ("Major security attack!", {"player_health": -22, "comp_health": -22, "xp": 3}),
        88: ("Credits stolen in a heist!", {"credits": -25, "xp": 3}),
        89: ("Companion in critical condition!", {"comp_health": -23, "xp": 3}),
        90: ("System surge, damage taken!", {"player_health": -23, "comp_health": -23, "xp": 3}),
        91: ("Security wipeout!", {"player_health": -24, "comp_health": -24, "xp": 3}),
        92: ("Lost credits and health!", {"credits": -20, "player_health": -25, "comp_health": -25, "xp": 3}),
        93: ("Companion badly injured!", {"comp_health": -26, "xp": 3}),
        94: ("System collapse!", {"player_health": -25, "comp_health": -25, "xp": 3}),
        95: ("Security hit hard!", {"player_health": -26, "comp_health": -26, "xp": 3}),
        96: ("Found a server medkit!", {"player_health": 12, "comp_health": 12, "xp": 8, "credits": 15}),
        97: ("Companion critically wounded!", {"comp_health": -27, "xp": 3}),
        98: ("System overload!", {"player_health": -27, "comp_health": -27, "xp": 3}),
        99: ("Security attack, critical hit!", {"player_health": -28, "comp_health": -28, "xp": 3}),
        100: ("Total system failure!", {"credits": -20, "player_health": -30, "comp_health": -30, "xp": 3})
    }

    outcomes_grid_wastelands = {
        1: ("Scavenged credits from wreckage!", {"credits": 30, "xp": 10}),
        2: ("Found a Nano Patch in ruins!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        3: ("Hacked a drone, scored points!", {"score": secrets.randbelow(10) + 15, "xp": 12, "credits": 10}),  # 15-24
        4: ("Traded scrap for crypto chips!", {"crypto_chips": 3, "xp": 10, "credits": 10}),
        5: ("Found a Neon Key in debris!", {"neon_key": 1, "xp": 8, "credits": 10}),
        6: ("Survived a storm, restored vitality!", {"player_health": 4, "comp_health": 4, "xp": 10, "credits": 10}),
        7: ("Found a Data Drive in a wreck!", {"data_drive": 1, "xp": 8, "credits": 10}),
        8: ("Quick hack netted credits!", {"credits": 25, "xp": 10}),
        9: ("Mutant attack hit you!", {"player_health": -5, "comp_health": -5, "xp": 3}),
        ...
        12: ("Found a medkit in the wastes!", {"player_health": 5, "comp_health": 5, "xp": 8, "credits": 10}),
        13: ("Outran a drone, gained XP!", {"xp": 12, "credits": 10}),
        14: ("Scavenged credits from a wreck!", {"credits": 20, "xp": 10}),
        15: ("Found a hidden Data Drive!", {"data_drive": 1, "xp": 8, "credits": 10}),
        16: ("Hacked a terminal, scored points!", {"score": secrets.randbelow(10) + 15, "xp": 10, "credits": 10}),  # 15-24
        17: ("Found a Neon Key in a ruin!", {"neon_key": 1, "xp": 8, "credits": 10}),
        18: ("Mutant ambush hit hard!", {"player_health": -6, "comp_health": -6, "xp": 3}),
        19: ("Won a fight, got credits!", {"credits": 35, "xp": 10}),
        ...
        24: ("Traded for credits in the wastes!", {"credits": 40, "xp": 10}),
        25: ("Found a Neon Key in a wreck!", {"neon_key": 1, "xp": 8, "credits": 10}),
        26: ("Hacked a system, scored big!", {"score": secrets.randbelow(10) + 20, "xp": 10, "credits": 10}),  # 20-29
        27: ("Mutant attack hit hard!", {"player_health": -7, "comp_health": -7, "xp": 3}),
        28: ("Scavenged credits from a ruin!", {"credits": 45, "xp": 10}),
        29: ("Found crypto chips in a stash!", {"crypto_chips": 4, "xp": 10, "credits": 10}),
        30: ("Learned wasteland skills, gained XP!", {"xp": 15, "credits": 10}),
        31: ("Scavenged a Nano Patch!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        32: ("Traded for a Data Drive!", {"data_drive": 1, "xp": 8, "credits": 10}),
        33: ("Big trade, huge credits!", {"credits": 50, "xp": 10}),
        34: ("Found a Neon Key in a ruin!", {"neon_key": 1, "xp": 8, "credits": 10}),
        35: ("Mutant trap hit hard!", {"player_health": -8, "comp_health": -8, "xp": 3}),
        36: ("Hacked a system, scored big!", {"score": secrets.randbelow(10) + 20, "xp": 10, "credits": 10}),  # 20-29
        37: ("Deal netted crypto chips!", {"crypto_chips": 4, "xp": 10, "credits": 10}),
        38: ("Found a Nano Patch in a wreck!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        39: ("Dodged a trap, health restored!", {"player_health": 5, "comp_health": 5, "xp": 8, "credits": 10}),
        40: ("Overcame a challenge, gained XP!", {"xp": 18, "credits": 15}),
        41: ("Traded for credits in a ruin!", {"credits": 55, "xp": 10}),
        ...
        45: ("Mutant ambush hit hard!", {"player_health": -9, "comp_health": -9, "xp": 3}),
        46: ("Hacked a system, earned credits!", {"credits": 60, "xp": 10}),
        47: ("Won a fight, gained crypto chips!", {"crypto_chips": 5, "xp": 10, "credits": 10}),
        48: ("Found a Nano Patch in a crate!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        49: ("Dodged a trap, health restored!", {"player_health": 6, "comp_health": 6, "xp": 8, "credits": 10}),
        50: ("Crypto Surge found! (Doubles credits for 2 events)", {"crypto_surge": 1, "credits": -7, "xp": 10}),
        51: ("Found a medkit in the wastes!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        52: ("Lost credits to a scavenger!", {"credits": -10, "xp": 3}),
        53: ("Companion caught in a trap!", {"comp_health": -10, "xp": 3}),
        54: ("Failed hack cost credits!", {"credits": -8, "xp": 3}),
        55: ("Mutant trap hit hard!", {"player_health": -10, "comp_health": -10, "xp": 3}),
        56: ("Bad deal cost credits!", {"credits": -12, "xp": 3}),
        57: ("Companion badly hurt!", {"comp_health": -11, "xp": 3}),
        58: ("Wasteland virus zapped you!", {"player_health": -11, "comp_health": -11, "xp": 3}),
        59: ("Lost crypto chips to a thief!", {"crypto_chips": -1, "xp": 3}),
        60: ("Ambushed by mutants!", {"player_health": -12, "comp_health": -12, "xp": 3}),
        61: ("Scammed, lost credits!", {"credits": -15, "xp": 3}),
        62: ("Companion injured in a fight!", {"comp_health": -13, "xp": 3}),
        63: ("Hack failed, took damage!", {"player_health": -13, "comp_health": -13, "xp": 3}),
        64: ("Credits stolen in a heist!", {"credits": -15, "xp": 3}),
        65: ("Companion hurt in a trap!", {"comp_health": -14, "xp": 3}),
        66: ("Wasteland surge drained vitality!", {"player_health": -14, "comp_health": -14, "xp": 3}),
        67: ("Found a hidden medkit!", {"player_health": 8, "comp_health": 8, "xp": 8, "credits": 10}),
        68: ("Scavengers took your credits!", {"credits": -18, "xp": 3}),
        69: ("Companion severely injured!", {"comp_health": -15, "xp": 3}),
        70: ("Deal gone wrong, lost credits!", {"credits": -20, "xp": 3}),
        71: ("Mutant assault hit hard!", {"player_health": -15, "comp_health": -15, "xp": 3}),
        72: ("Trap cost you credits!", {"credits": -12, "xp": 3}),
        73: ("Companion took a bad hit!", {"comp_health": -16, "xp": 3}),
        74: ("Wasteland virus, damage taken!", {"player_health": -16, "comp_health": -16, "xp": 3}),
        75: ("Heist wiped out credits!", {"credits": -22, "xp": 3}),
        76: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        77: ("Severe mutant assault!", {"player_health": -17, "comp_health": -17, "xp": 3}),
        78: ("Lost credits in a scam!", {"credits": -15, "xp": 3}),
        79: ("Companion critically wounded!", {"comp_health": -18, "xp": 3}),
        80: ("Mutants took down companion!", {"comp_health": -19, "xp": 3}),
        81: ("Mutant assault hit hard!", {"player_health": -18, "comp_health": -18, "xp": 3}),
        82: ("Fight drained credits!", {"credits": -20, "xp": 3}),
        83: ("Companion hurt badly!", {"comp_health": -20, "xp": 3}),
        84: ("Wasteland outage, damage taken!", {"player_health": -19, "comp_health": -19, "xp": 3}),
        85: ("Scam cost you credits!", {"credits": -18, "xp": 3}),
        86: ("Found a hidden cache!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 15}),
        87: ("Major mutant attack!", {"player_health": -20, "comp_health": -20, "xp": 3}),
        88: ("Credits stolen in a heist!", {"credits": -25, "xp": 3}),
        89: ("Companion in critical condition!", {"comp_health": -21, "xp": 3}),
        90: ("Wasteland surge, damage taken!", {"player_health": -21, "comp_health": -21, "xp": 3}),
        91: ("Mutant wipeout!", {"player_health": -22, "comp_health": -22, "xp": 3}),
        92: ("Lost credits and health!", {"credits": -20, "player_health": -23, "comp_health": -23, "xp": 3}),
        93: ("Companion badly injured!", {"comp_health": -24, "xp": 3}),
        94: ("Wasteland collapse!", {"player_health": -24, "comp_health": -24, "xp": 3}),
        95: ("Mutant hit hard!", {"player_health": -25, "comp_health": -25, "xp": 3}),
        96: ("Found a wasteland medkit!", {"player_health": 12, "comp_health": 12, "xp": 8, "credits": 15}),
        97: ("Companion critically wounded!", {"comp_health": -26, "xp": 3}),
        98: ("Wasteland overload!", {"player_health": -26, "comp_health": -26, "xp": 3}),
        99: ("Mutant attack, critical hit!", {"player_health": -27, "comp_health": -27, "xp": 3}),
        100: ("Total wasteland failure!", {"credits": -20, "player_health": -30, "comp_health": -30, "xp": 3})
    }
...
def inventory():
    ...
    while True:
        ...
        print(Fore.YELLOW + f"Data Drive ({player['data_drive']}): Boosts score..." + Style.RESET_ALL)
...
def main():
    ...
    while True:
        ...
        if player["crypto_surge_events"] > 0:
            print(Fore.MAGENTA + f"Crypto Surge active: Credits will double for {player['crypto_surge_events']} more event(s)" + Style.RESET_ALL)
        ...
        if player["score"] >= 6000 and player["crypto_chips"] >= 300 and player["quantum_core"] >= 50:
            ...
            print(Fore.MAGENTA + f"Final Credits: {player['credits']}" + Style.RESET_ALL)
            print(Fore.MAGENTA + f"Final Crypto Surges: {player['crypto_surge']}" + Style.RESET_ALL)
