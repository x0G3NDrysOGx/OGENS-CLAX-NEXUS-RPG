...
def path_outcomes(path, outcome):
    ...
    outcomes_ancient_crypts = {
        ...
        6: ("Dodged a trap, vitality restored!", {"player_health": 5, "comp_health": 5, "xp": 8}),
        ...
        12: ("Ancient elixir healed wounds!", {"player_health": 10, "comp_health": 10, "xp": 8}),
        ...
        39: ("Dodged a spectral trap, healed!", {"player_health": 6, "comp_health": 6, "xp": 8}),
        ...
        49: ("Dodged a curse, vitality restored!", {"player_health": 7, "comp_health": 7, "xp": 8}),
    ...
    outcomes_enchanted_forest = {
        ...
        6: ("Healed by forest magic!", {"player_health": 6, "comp_health": 6, "xp": 8}),
        ...
        12: ("Forest spring healed you!", {"player_health": 12, "comp_health": 12, "xp": 8}),
        ...
        39: ("Dodged a trap, healed!", {"player_health": 7, "comp_health": 7, "xp": 8}),
        ...
        49: ("Dodged a curse, vitality restored!", {"player_health": 8, "comp_health": 8, "xp": 8}),
        50: ("Rune Pulse found! (Doubles runes for 2 events)", {"rune_pulse": 1, "xp": 10})
    }
    ...
    outcomes_mystic_ruins = {
        ...
        6: ("Healed by ancient magic!", {"player_health": 7, "comp_health": 7, "xp": 8}),
        ...
        12: ("Ancient shrine healed you!", {"player_health": 14, "comp_health": 14, "xp": 8}),
        ...
        39: ("Dodged a rune trap, healed!", {"player_health": 8, "comp_health": 8, "xp": 8}),
        ...
        49: ("Dodged a trap, vitality restored!", {"player_health": 9, "comp_health": 9, "xp": 8}),
        50: ("Rune Pulse found! (Doubles runes for 2 events)", {"rune_pulse": 1, "xp": 10})
    }
    ...
    outcomes_shadow_realm = {
        ...
        6: ("Survived a dark surge, healed!", {"player_health": 5, "comp_health": 5, "xp": 8}),
        ...
        12: ("Dark shrine healed you!", {"player_health": 10, "comp_health": 10, "xp": 8}),
        ...
        39: ("Dodged a dark trap, healed!", {"player_health": 6, "comp_health": 6, "xp": 8}),
