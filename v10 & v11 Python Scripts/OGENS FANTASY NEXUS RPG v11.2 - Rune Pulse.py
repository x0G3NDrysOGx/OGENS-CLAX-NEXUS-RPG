...
def path_outcomes(path, outcome):
    ...
    outcomes_ancient_crypts = {
        1: ("Avoided a skeleton ambush, found runes!", {"runes": 20, "xp": 10}),
        2: ("Discovered a Healing Potion in a tomb!", {"healing_potion": 1, "xp": 8}),
        3: ("Deciphered a crypt rune, gained renown!", {"score": secrets.randbelow(10) + 10, "xp": 12}),
        4: ("Traded with a shade, earned runes!", {"runes": 25, "xp": 10}),
        5: ("Found a Mystic Key in a sarcophagus!", {"mystic_key": 1, "xp": 8}),
        6: ("Dodged a trap, vitality restored!", {"player_health": 3, "comp_health": 3, "xp": 8}),  # 5/2 = 2.5 -> 3
        7: ("Recovered a Magic Scroll from a crypt!", {"magic_scroll": 1, "xp": 8}),
        8: ("Chanted a spell, gained runes!", {"runes": 15, "xp": 10}),
        9: ("Cursed trap drained your vitality!", {"player_health": -5, "comp_health": -5, "xp": 1}),
        10: ("Found an Arcane Crystal in a vault!", {"arcane_crystal": 1, "xp": 10}),
        11: ("Bargained with a ghost, gained runes!", {"runes": 20, "xp": 10}),
        12: ("Ancient elixir healed wounds!", {"player_health": 5, "comp_health": 5, "xp": 8}),  # 10/2 = 5
        13: ("Outwitted a wraith, gained wisdom!", {"xp": 10}),
        14: ("Looted runes from a crypt!", {"runes": 25, "xp": 10}),
        15: ("Found a Magic Scroll in a chest!", {"magic_scroll": 1, "xp": 8}),
        16: ("Chanted runes, boosted renown!", {"score": secrets.randbelow(10) + 15, "xp": 10}),
        17: ("Unearthed a Mystic Key in the dust!", {"mystic_key": 1, "xp": 8}),
        18: ("Skeleton ambush struck hard!", {"player_health": -6, "comp_health": -6, "xp": 1}),
        19: ("Defeated a wight, gained runes!", {"runes": 30, "xp": 10}),
        20: ("Snagged a Healing Potion from a shrine!", {"healing_potion": 1, "xp": 8}),
        21: ("Unraveled a spell, gained runes!", {"runes": 25, "xp": 10}),
        22: ("Found a Magic Scroll in a crypt!", {"magic_scroll": 1, "xp": 8}),
        23: ("Evaded a curse, gained wisdom!", {"xp": 12}),
        24: ("Traded with a spirit, earned runes!", {"runes": 35, "xp": 10}),
        25: ("Found a Mystic Key in a tomb!", {"mystic_key": 1, "xp": 8}),
        26: ("Mastered a rune, big renown!", {"score": secrets.randbelow(10) + 15, "xp": 10}),
        27: ("Cursed blade struck you!", {"player_health": -7, "comp_health": -7, "xp": 1}),
        28: ("Looted a crypt, gained runes!", {"runes": 40, "xp": 10}),
        29: ("Found runes in a hidden vault!", {"runes": 30, "xp": 10}),
        30: ("Learned ancient lore, gained wisdom!", {"xp": 15}),
        31: ("Recovered a Healing Potion!", {"healing_potion": 1, "xp": 8}),
        32: ("Found a Magic Scroll in a shrine!", {"magic_scroll": 1, "xp": 8}),
        33: ("Major rune haul from a crypt!", {"runes": 45, "xp": 10}),
        34: ("Found a Mystic Key in a vault!", {"mystic_key": 1, "xp": 8}),
        35: ("Cursed trap hit hard!", {"player_health": -8, "comp_health": -8, "xp": 1}),
        36: ("Chanted a powerful spell, big renown!", {"score": secrets.randbelow(10) + 20, "xp": 10}),
        37: ("Traded with a lich, gained runes!", {"runes": 35, "xp": 10}),
        38: ("Found a Healing Potion in a crypt!", {"healing_potion": 1, "xp": 8}),
        39: ("Dodged a spectral trap, healed!", {"player_health": 3, "comp_health": 3, "xp": 8}),  # 6/2 = 3
        40: ("Overcame a guardian, gained wisdom!", {"xp": 18}),
        41: ("Looted a tomb, gained runes!", {"runes": 50, "xp": 10}),
        42: ("Found an Arcane Crystal in a crypt!", {"arcane_crystal": 1, "xp": 10}),
        43: ("Mastered a spell, huge renown!", {"score": secrets.randbelow(10) + 25, "xp": 10}),
        44: ("Found a Mystic Key in a shrine!", {"mystic_key": 1, "xp": 8}),
        45: ("Wraith attack drained you!", {"player_health": -9, "comp_health": -9, "xp": 1}),
        46: ("Chanted runes, earned runes!", {"runes": 55, "xp": 10}),
        47: ("Defeated a specter, gained runes!", {"runes": 40, "xp": 10}),
        48: ("Found a Healing Potion in a vault!", {"healing_potion": 1, "xp": 8}),
        49: ("Dodged a curse, vitality restored!", {"player_health": 4, "comp_health": 4, "xp": 8}),  # 7/2 = 3.5 -> 4
        50: ("Rune Pulse found! (Doubles runes for 2 events)", {"rune_pulse": 1, "xp": 10})
    }

    outcomes_enchanted_forest = {
        1: ("Evaded a dire wolf, found runes!", {"runes": 25, "xp": 10}),
        2: ("Found a Healing Potion under a tree!", {"healing_potion": 1, "xp": 8}),
        3: ("Charmed a sprite, gained renown!", {"score": secrets.randbelow(10) + 15, "xp": 12}),
        4: ("Traded with a dryad, earned runes!", {"runes": 30, "xp": 10}),
        5: ("Found a Mystic Key in a glade!", {"mystic_key": 1, "xp": 8}),
        6: ("Healed by forest magic!", {"player_health": 3, "comp_health": 3, "xp": 8}),  # 6/2 = 3
        7: ("Found a Magic Scroll in a hollow!", {"magic_scroll": 1, "xp": 8}),
        8: ("Gained runes from a fairy!", {"runes": 20, "xp": 10}),
        9: ("Entangled by vines, hurt!", {"player_health": -6, "comp_health": -6, "xp": 1}),
        10: ("Found an Arcane Crystal in a spring!", {"arcane_crystal": 1, "xp": 10}),
        11: ("Befriended a fae, gained runes!", {"runes": 25, "xp": 10}),
        12: ("Forest spring healed you!", {"player_health": 6, "comp_health": 6, "xp": 8}),  # 12/2 = 6
        13: ("Outran a beast, gained wisdom!", {"xp": 10}),
        14: ("Traded with elves, earned runes!", {"runes": 30, "xp": 10}),
        15: ("Found a Magic Scroll in a grove!", {"magic_scroll": 1, "xp": 8}),
        16: ("Charmed a spirit, big renown!", {"score": secrets.randbelow(10) + 15, "xp": 10}),
        17: ("Found a Mystic Key in a tree!", {"mystic_key": 1, "xp": 8}),
        18: ("Beast attack struck hard!", {"player_health": -7, "comp_health": -7, "xp": 1}),
        19: ("Defeated a troll, gained runes!", {"runes": 35, "xp": 10}),
        20: ("Found a Healing Potion in a glade!", {"healing_potion": 1, "xp": 8}),
        21: ("Learned forest magic, gained runes!", {"runes": 30, "xp": 10}),
        22: ("Found a Magic Scroll in a den!", {"magic_scroll": 1, "xp": 8}),
        23: ("Evaded a trap, gained wisdom!", {"xp": 12}),
        24: ("Traded with a fae, earned runes!", {"runes": 40, "xp": 10}),
        25: ("Found a Mystic Key in a spring!", {"mystic_key": 1, "xp": 8}),
        26: ("Mastered forest magic, big renown!", {"score": secrets.randbelow(10) + 20, "xp": 10}),
        27: ("Poisoned thorns struck you!", {"player_health": -8, "comp_health": -8, "xp": 1}),
        28: ("Found runes in a fairy ring!", {"runes": 45, "xp": 10}),
        29: ("Gained runes from a druid!", {"runes": 35, "xp": 10}),
        30: ("Learned forest lore, gained wisdom!", {"xp": 15}),
        31: ("Found a Healing Potion in a grove!", {"healing_potion": 1, "xp": 8}),
        32: ("Found a Magic Scroll in a tree!", {"magic_scroll": 1, "xp": 8}),
        33: ("Major rune haul from a glade!", {"runes": 50, "xp": 10}),
        34: ("Found a Mystic Key in a hollow!", {"mystic_key": 1, "xp": 8}),
        35: ("Beast trap hit hard!", {"player_health": -9, "comp_health": -9, "xp": 1}),
        36: ("Charmed a spirit, huge renown!", {"score": secrets.randbelow(10) + 20, "xp": 10}),
        37: ("Traded with a nymph, gained runes!", {"runes": 40, "xp": 10}),
        38: ("Found a Healing Potion in a den!", {"healing_potion": 1, "xp": 8}),
        39: ("Dodged a trap, healed!", {"player_health": 4, "comp_health": 4, "xp": 8}),  # 7/2 = 3.5 -> 4
        40: ("Overcame a beast, gained wisdom!", {"xp": 18}),
        41: ("Found runes in a sacred grove!", {"runes": 55, "xp": 10}),
        42: ("Found an Arcane Crystal in a glade!", {"arcane_crystal": 1, "xp": 10}),
        43: ("Mastered a spell, huge renown!", {"score": secrets.randbelow(10) + 25, "xp": 10}),
        44: ("Found a Mystic Key in a grove!", {"mystic_key": 1, "xp": 8}),
        45: ("Dire beast attacked!", {"player_health": -10, "comp_health": -10, "xp": 1}),
        46: ("Learned forest magic, earned runes!", {"runes": 60, "xp": 10}),
        47: ("Defeated a wyrm, gained runes!", {"runes": 45, "xp": 10}),
        48: ("Found a Healing Potion in a spring!", {"healing_potion": 1, "xp": 8}),
        49: ("Dodged a curse, vitality restored!", {"player_health": 4, "comp_health": 4, "xp": 8}),  # 8/2 = 4
        50: ("Rune Pulse found! (Doubles runes for 2 events)", {"rune_pulse": 1, "xp": 10})
    }

    outcomes_mystic_ruins = {
        1: ("Bypassed a golem, found runes!", {"runes": 30, "xp": 10}),
        2: ("Found a Healing Potion in ruins!", {"healing_potion": 1, "xp": 8}),
        3: ("Deciphered a rune, big renown!", {"score": secrets.randbelow(10) + 20, "xp": 12}),
        4: ("Traded with a spirit, earned runes!", {"runes": 35, "xp": 10}),
        5: ("Found a Mystic Key in a ruin!", {"mystic_key": 1, "xp": 8}),
        6: ("Healed by ancient magic!", {"player_health": 4, "comp_health": 4, "xp": 8}),  # 7/2 = 3.5 -> 4
        7: ("Found a Magic Scroll in a ruin!", {"magic_scroll": 1, "xp": 8}),
        8: ("Chanted runes, gained runes!", {"runes": 25, "xp": 10}),
        9: ("Rune trap drained you!", {"player_health": -7, "comp_health": -7, "xp": 1}),
        10: ("Found an Arcane Crystal in a vault!", {"arcane_crystal": 1, "xp": 10}),
        11: ("Bargained with a shade, gained runes!", {"runes": 30, "xp": 10}),
        12: ("Ancient shrine healed you!", {"player_health": 7, "comp_health": 7, "xp": 8}),  # 14/2 = 7
        13: ("Outwitted a guardian, gained wisdom!", {"xp": 12}),
        14: ("Looted runes from ruins!", {"runes": 35, "xp": 10}),
        15: ("Found a Magic Scroll in a vault!", {"magic_scroll": 1, "xp": 8}),
        16: ("Mastered a rune, big renown!", {"score": secrets.randbelow(10) + 20, "xp": 10}),
        17: ("Found a Mystic Key in a ruin!", {"mystic_key": 1, "xp": 8}),
        18: ("Golem attack struck hard!", {"player_health": -8, "comp_health": -8, "xp": 1}),
        19: ("Defeated a sentinel, gained runes!", {"runes": 40, "xp": 10}),
        20: ("Found a Healing Potion in a shrine!", {"healing_potion": 1, "xp": 8}),
        21: ("Learned ruin magic, gained runes!", {"runes": 35, "xp": 10}),
        22: ("Found a Magic Scroll in a vault!", {"magic_scroll": 1, "xp": 8}),
        23: ("Evaded a trap, gained wisdom!", {"xp": 14}),
        24: ("Traded with a ghost, earned runes!", {"runes": 45, "xp": 10}),
        25: ("Found a Mystic Key in a ruin!", {"mystic_key": 1, "xp": 8}),
        26: ("Chanted a spell, huge renown!", {"score": secrets.randbelow(10) + 25, "xp": 10}),
        27: ("Rune trap hit hard!", {"player_health": -9, "comp_health": -9, "xp": 1}),
        28: ("Looted a vault, gained runes!", {"runes": 50, "xp": 10}),
        29: ("Found runes in a hidden chamber!", {"runes": 40, "xp": 10}),
        30: ("Learned ancient secrets, gained wisdom!", {"xp": 16}),
        31: ("Found a Healing Potion in a ruin!", {"healing_potion": 1, "xp": 8}),
        32: ("Found a Magic Scroll in a shrine!", {"magic_scroll": 1, "xp": 8}),
        33: ("Major rune haul from a vault!", {"runes": 55, "xp": 10}),
        34: ("Found a Mystic Key in a chamber!", {"mystic_key": 1, "xp": 8}),
        35: ("Guardian trap hit hard!", {"player_health": -10, "comp_health": -10, "xp": 1}),
        36: ("Mastered a spell, huge renown!", {"score": secrets.randbelow(10) + 25, "xp": 10}),
        37: ("Traded with a spirit, gained runes!", {"runes": 45, "xp": 10}),
        38: ("Found a Healing Potion in a vault!", {"healing_potion": 1, "xp": 8}),
        39: ("Dodged a rune trap, healed!", {"player_health": 4, "comp_health": 4, "xp": 8}),  # 8/2 = 4
        40: ("Overcame a guardian, gained wisdom!", {"xp": 20}),
        41: ("Looted a chamber, gained runes!", {"runes": 60, "xp": 10}),
        42: ("Found an Arcane Crystal in a ruin!", {"arcane_crystal": 1, "xp": 10}),
        43: ("Chanted a powerful spell, huge renown!", {"score": secrets.randbelow(10) + 30, "xp": 10}),
        44: ("Found a Mystic Key in a vault!", {"mystic_key": 1, "xp": 8}),
        45: ("Rune surge drained you!", {"player_health": -11, "comp_health": -11, "xp": 1}),
        46: ("Mastered ruin magic, earned runes!", {"runes": 65, "xp": 10}),
        47: ("Defeated a golem, gained runes!", {"runes": 50, "xp": 10}),
        48: ("Found a Healing Potion in a chamber!", {"healing_potion": 1, "xp": 8}),
        49: ("Dodged a trap, vitality restored!", {"player_health": 5, "comp_health": 5, "xp": 8}),  # 9/2 = 4.5 -> 5
        50: ("Rune Pulse found! (Doubles runes for 2 events)", {"rune_pulse": 1, "xp": 10})
    }

    outcomes_shadow_realm = {
        1: ("Evaded a shadow beast, found runes!", {"runes": 20, "xp": 10}),
        2: ("Found a Healing Potion in the dark!", {"healing_potion": 1, "xp": 8}),
        3: ("Banished a shade, gained renown!", {"score": secrets.randbelow(10) + 10, "xp": 12}),
        4: ("Traded with a wraith, earned runes!", {"runes": 25, "xp": 10}),
        5: ("Found a Mystic Key in the shadows!", {"mystic_key": 1, "xp": 8}),
        6: ("Survived a dark surge, healed!", {"player_health": 3, "comp_health": 3, "xp": 8}),  # 5/2 = 2.5 -> 3
        7: ("Found a Magic Scroll in a void!", {"magic_scroll": 1, "xp": 8}),
        8: ("Chanted runes, gained runes!", {"runes": 15, "xp": 10}),
        9: ("Shadow trap drained you!", {"player_health": -5, "comp_health": -5, "xp": 1}),
        10: ("Found an Arcane Crystal in the dark!", {"arcane_crystal": 1, "xp": 10}),
        11: ("Bargained with a demon, gained runes!", {"runes": 20, "xp": 10}),
        12: ("Dark shrine healed you!", {"player_health": 5, "comp_health": 5, "xp": 8}),  # 10/2 = 5
        13: ("Outwitted a shadow, gained wisdom!", {"xp": 10}),
        14: ("Looted runes from a void!", {"runes": 25, "xp": 10}),
        15: ("Found a Magic Scroll in a shrine!", {"magic_scroll": 1, "xp": 8}),
        16: ("Banished a spirit, big renown!", {"score": secrets.randbelow(10) + 15, "xp": 10}),
        17: ("Found a Mystic Key in a void!", {"mystic_key": 1, "xp": 8}),
        18: ("Shadow beast struck hard!", {"player_health": -6, "comp_health": -6, "xp": 1}),
        19: ("Defeated a demon, gained runes!", {"runes": 30, "xp": 10}),
        20: ("Found a Healing Potion in a shrine!", {"healing_potion": 1, "xp": 8}),
        21: ("Learned dark magic, gained runes!", {"runes": 25, "xp": 10}),
        22: ("Found a Magic Scroll in the dark!", {"magic_scroll": 1, "xp": 8}),
        23: ("Evaded a curse, gained wisdom!", {"xp": 12}),
        24: ("Traded with a shade, earned runes!", {"runes": 35, "xp": 10}),
        25: ("Found a Mystic Key in a void!", {"mystic_key": 1, "xp": 8}),
        26: ("Mastered dark magic, big renown!", {"score": secrets.randbelow(10) + 15, "xp": 10}),
        27: ("Dark surge hit hard!", {"player_health": -7, "comp_health": -7, "xp": 1}),
        28: ("Looted a void, gained runes!", {"runes": 40, "xp": 10}),
        29: ("Found runes in a dark shrine!", {"runes": 30, "xp": 10}),
        30: ("Learned shadow lore, gained wisdom!", {"xp": 15}),
        31: ("Found a Healing Potion in a void!", {"healing_potion": 1, "xp": 8}),
        32: ("Found a Magic Scroll in a shrine!", {"magic_scroll": 1, "xp": 8}),
        33: ("Major rune haul from a void!", {"runes": 45, "xp": 10}),
        34: ("Found a Mystic Key in a shrine!", {"mystic_key": 1, "xp": 8}),
        35: ("Shadow trap hit hard!", {"player_health": -8, "comp_health": -8, "xp": 1}),
        36: ("Banished a demon, huge renown!", {"score": secrets.randbelow(10) + 20, "xp": 10}),
        37: ("Traded with a wraith, gained runes!", {"runes": 35, "xp": 10}),
        38: ("Found a Healing Potion in a void!", {"healing_potion": 1, "xp": 8}),
        39: ("Dodged a dark trap, healed!", {"player_health": 3, "comp_health": 3, "xp": 8}),  # 6/2 = 3
        40: ("Overcame a shadow, gained wisdom!", {"xp": 18}),
        41: ("Looted a dark shrine, gained runes!", {"runes": 50, "xp": 10}),
        42: ("Found an Arcane Crystal in a void!", {"arcane_crystal": 1, "xp": 10}),
        43: ("Mastered a dark spell, huge renown!", {"score": secrets.randbelow(10) + 25, "xp": 10}),
        44: ("Found a Mystic Key in a shrine!", {"mystic_key": 1, "xp": 8}),
        45: ("Shadow beast drained you!", {"player_health": -9, "comp_health": -9, "xp": 1}),
        46: ("Learned dark magic, earned runes!", {"runes": 55, "xp": 10}),
        47: ("Defeated a nightmare, gained runes!", {"runes": 40, "xp": 10}),
        48: ("Found a Healing Potion in a shrine!", {"healing_potion": 1, "xp": 8}),
        49: ("Dodged a curse, vitality restored!", {"player_health": 4, "comp_health": 4, "xp": 8}),  # 7/2 = 3.5 -> 4
        50: ("Rune Pulse found! (Doubles runes for 2 events)", {"rune_pulse": 1, "xp": 10})
    }
