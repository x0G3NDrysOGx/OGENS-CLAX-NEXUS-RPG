...
def load_game():
    ...
    try:
        ...
        if current_companion["name"] in companion_stats:
            ...
            # If no valid current companion, select a random one (including deactivated)
...
def roll_dice():
    ...
    outcome = (die1 - 1) * 10 + die2  # Maps to 1-100 (10x10 grid)
...
def path_outcomes(path, outcome):
    ...
    outcomes_grid_wastelands = {
        ...
        64: ("Your deal sparks a raider ambush", {"comp_health": -5, "xp": 1, "player_health": -5}),
        65: ("A glitch swarm overwhelms your defenses", {"comp_health": -2, "xp": 1, "player_health": -2}),
        ...
        72: ("You defeat a wasteland raider, claiming a Quantum Core", {"score": 5 + player["level"], "quantum_core": 1, "xp": 8, "player_health": 4, "comp_health": 4}),
        73: ("You broker a deal with a rogue AI, gaining a Nano Patch", {"score": 5 + player["level"], "nano_patch": 1, "xp": 8, "player_health": 4, "comp_health": 4}),
        74: ("You unlock a ruined vault, finding a Data Drive", {"score": 6 + player["level"], "data_drive": 1, "xp": 10, "player_health": 4, "comp_health": 4}),
        75: ("A laser grid traps you in the wastelands", {"comp_health": -5, "xp": 1, "player_health": -5}),
        76: ("A hacked drone attacks you", {"comp_health": -6, "xp": 1, "player_health": -6}),
        77: ("You stabilize a glitched node, gaining a Crypto Chip", {"score": 6 + player["level"], "crypto_chips": 1, "xp": 10, "player_health": 4, "comp_health": 4}),
        78: ("A viral spike shorts your systems", {"comp_health": -5, "xp": 1, "player_health": -5}),
        79: ("You bypass a scavenger trap, securing a Neon Key", {"score": 5 + player["level"], "neon_key": 1, "xp": 8, "player_health": 4, "comp_health": 4}),
        ...
        81: ("A scavenger betrays you to raiders", {"comp_health": -6, "xp": 1, "player_health": -6}),
        82: ("You hack a hidden terminal, uncovering a Data Drive", {"score": 8 + player["level"], "data_drive": 1, "xp": 10, "player_health": 4, "comp_health": 4}),
        83: ("Your signal draws a bounty hunter", {"comp_health": -7, "xp": 1, "player_health": -7}),
        84: ("A collapsing structure traps you", {"comp_health": -5, "xp": 1, "player_health": -5}),
        85: ("You gain a scavenger’s trust, earning a Crypto Chip", {"score": 5 + player["level"], "crypto_chips": 1, "xp": 8, "player_health": 4, "comp_health": 4}),
        ...
        89: ("Your actions spark a raider alert", {"comp_health": -5, "xp": 1, "player_health": -5}),
        ...
        92: ("A swarm of raider bots attacks", {"comp_health": -7, "xp": 1, "player_health": -7}),
        93: ("You barter with a wasteland nomad, earning a Neon Key", {"score": 5 + player["level"], "neon_key": 1, "xp": 8, "player_health": 4, "comp_health": 4}),
        ...
        98: ("You unlock a ruined server, gaining a Nano Patch", {"score": 5 + player["level"], "nano_patch": 1, "xp": 8, "player_health": 4, "comp_health": 4}),
        99: ("A rigged node traps you in a datastream", {"comp_health": -5, "xp": 1, "player_health": -5}),
    ...
    strength_modifier = 2.1 - (player["player_strength"] / 17.5)  # Maps strength 5 -> ~1.8143, 10 -> ~1.5286, 15 -> ~1.2429
    if "player_health" in changes and changes["player_health"] < 0:
        ...
        if player["player_strength"] <= 5:
            changes["player_health"] = max(scaled_damage, -9)  # Cap at -9 for strength <= 5
        elif player["player_strength"] <= 9:
            changes["player_health"] = max(scaled_damage, -7)  # Cap at -7 for strength 6-9
        elif player["player_strength"] == 10:
            changes["player_health"] = max(scaled_damage, -6)  # Cap at -6 for strength 10
        elif player["player_strength"] <= 14:
            changes["player_health"] = max(scaled_damage, -4)  # Cap at -4 for strength 11-14
        else:
            changes["player_health"] = max(scaled_damage, -2)  # Cap at -2 for strength >= 15
    if "comp_health" in changes and changes["comp_health"] < 0:
        scaled_damage = round(changes["comp_health"] * strength_modifier)
        if player["player_strength"] <= 5:
            changes["comp_health"] = max(scaled_damage, -9)  # Cap at -9 for strength <= 5
        elif player["player_strength"] <= 9:
            changes["comp_health"] = max(scaled_damage, -7)  # Cap at -7 for strength 6-9
        elif player["player_strength"] == 10:
            changes["comp_health"] = max(scaled_damage, -6)  # Cap at -6 for strength 10
        elif player["player_strength"] <= 14:
            changes["comp_health"] = max(scaled_damage, -4)  # Cap at -4 for strength 11-14
        else:
            changes["comp_health"] = max(scaled_damage, -2)  # Cap at -2 for strength >= 15
        ...
        if choice in ["1", "2", "3", "4"]:
            try:
                ...
                if was_deactivated and is_positive_outcome(changes) and current_companion["name"]:
                    revival_health_change = 10  # Track revival bonus for display
