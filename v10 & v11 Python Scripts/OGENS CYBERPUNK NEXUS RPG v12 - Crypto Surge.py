...
def path_outcomes(path, outcome):
    ...
    outcomes_neon_underdistrict = {
        ...
        6: ("Dodged a trap, sharpened your skills!", {"xp": 10, "player_health": 5, "credits": 10}),
        ...
        12: ("Street medkit patched you up!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 10}),
        ...
        39: ("Dodged a trap, patched up!", {"player_health": 5, "comp_health": 5, "xp": 8, "credits": 10}),
        ...
        50: ("Crypto Surge found! (Doubles crypto chips for 2 events)", {"crypto_surge": 1, "credits": -10, "xp": 10}),
    ...
    outcomes_corporate_skyspire = {
        ...
        6: ("Evaded drones, gained vitality!", {"player_health": 6, "comp_health": 6, "xp": 8, "credits": 10}),
        ...
        12: ("Corporate medkit restored health!", {"player_health": 12, "comp_health": 12, "xp": 8, "credits": 10}),
        ...
        39: ("Dodged a trap, health restored!", {"player_health": 7, "comp_health": 7, "xp": 8, "credits": 10}),
        40: ("Overcame a challenge, gained XP!", {"xp": 18, "credits": 10}),
        ...
        50: ("Crypto Surge in a safe! (Doubles crypto chips for 2 events)", {"crypto_surge": 1, "credits": -12, "xp": 10}),
    ...
    outcomes_data_vault = {
        ...
        5: ("Found a Neon Key in a vault!", {"neon_key": 1, "xp": 8, "credits": 10}),
        6: ("Evaded a virus, gained vitality!", {"player_health": 7, "comp_health": 7, "xp": 8, "credits": 10}),
        ...
        12: ("Server medkit restored health!", {"player_health": 14, "comp_health": 14, "xp": 8, "credits": 10}),
        ...
        39: ("Dodged a virus, health restored!", {"player_health": 9, "comp_health": 9, "xp": 8, "credits": 10}),
        ...
        48: ("Found a Nano Patch in a crate!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        49: ("Dodged a trap, health restored!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 10}),
        50: ("Crypto Surge found! (Doubles crypto chips for 2 events)", {"crypto_surge": 1, "credits": -15, "xp": 10}),
    ...
    outcomes_grid_wastelands = {
        ...
        6: ("Survived a storm, gained vitality!", {"player_health": 5, "comp_health": 5, "xp": 8, "credits": 10}),
        ...
        12: ("Found a medkit in the wastes!", {"player_health": 10, "comp_health": 10, "xp": 8, "credits": 10}),
        ...
        47: ("Won a fight, gained crypto chips!", {"crypto_chips": 4, "xp": 10, "credits": 10}),
        48: ("Found a Nano Patch in a crate!", {"nano_patch": 1, "xp": 8, "credits": 10}),
        49: ("Dodged a trap, health restored!", {"player_health": 7, "comp_health": 7, "xp": 8, "credits": 10}),
        50: ("Crypto Surge found! (Doubles crypto chips for 2 events)", {"crypto_surge": 1, "credits": -7, "xp": 10}),
    ...
    if player["crypto_surge_events"] > 0 and "crypto_chips" in changes and changes["crypto_chips"] > 0:
        changes["crypto_chips"] *= 2
        player["crypto_surge_events"] -= 1
        crypto_surge_message = f"Crypto Chips doubled by Crypto Surge ({player['crypto_surge_events']} events left)"
...
def inventory():
    ...
    while True:
        ...
        print(Fore.MAGENTA + f"Crypto Surge ({player['crypto_surge']}): Doubles crypto chips for next 2 events..." + Style.RESET_ALL)
        ...
        print(Fore.GREEN + "5. Crypto Surge (Double crypto chips for next 2 events)" + Style.RESET_ALL)
        ...
        if inv_choice == "1":
            ...
            if player["crypto_surge"] > 0:
                ...
                stat_changes = "Crypto Surge used - Crypto Chips will double for next 2 events, Crypto Surges -1"
                print(Fore.GREEN + "\nCrypto Surge used - Next 2 events' crypto chip gains will be doubled..." + Style.RESET_ALL)
            else:
...
def shop():
    ...
    while True:
        ...
        for item, base_price in shop_items.items():
            ...
            current_price = int(base_price * (1 + price_modifier))
            print(Fore.GREEN + f"{item.replace('_', ' ').title()} - Price: {current_price} credits" + Style.RESET_ALL)
        ...
        price_modifier = (secrets.randbelow(50) + 25) / 100
        current_price = int(shop_items[selected_item] * (1 + price_modifier))
    ...
    while True:
        ...
        if choice == "0":
            ...
            try:
                ...
                # Use current companion if active, otherwise select a new one
                if not current_companion["name"] or current_companion["health"] <= 0:
                    companion_name = secrets.choice([name for name in companions if name not in deactivated_companions])
                    current_companion.update({
                        "name": companion_name,
                        "health": max(0, min(companion_stats[companion_name]["health"], 100)),
                        "strength": companion_stats[companion_name]["strength"],
                ...
                # Apply changes (excluding companion health, as path_outcomes handles it)
