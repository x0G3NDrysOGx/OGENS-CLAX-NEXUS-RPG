...
if !outcome! == 3 (set "result=Stealth Chaos: You knock over crates, alerting the market" & set /a comp_health_change=-5 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-5 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
...
if !outcome! == 7 (set "result=Combat Chaos: Your fight trashes the market" & set /a comp_health_change=-12 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-12 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
...
if !outcome! == 11 (set "result=Social Chaos: Your haggling starts a brawl" & set /a comp_health_change=-5 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-5 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
...
if !outcome! == 22 (set "result=Social Success: You barter for a Data Shard" & set /a score_change=6 + !level! & set /a shard_change=1 & set /a xp_change=10 & set /a comp_health_change=4 & set /a player_health_change=4 & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
...
if !outcome! == 3 (set "result=Stealth Chaos: Your infiltration crashes a node" & set /a comp_health_change=-5 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-5 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
...
if !outcome! == 7 (set "result=Combat Chaos: Your attack destabilizes the grid" & set /a comp_health_change=-12 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-12 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
...
if !outcome! == 11 (set "result=Social Chaos: Your bluff crashes the node" & set /a comp_health_change=-5 + !char_strength! & set /a xp_change=1 & set /a player_health_change=-5 + !player_strength! & set /a display_player_health_change=!player_health_change! & set show_health_change=1)
