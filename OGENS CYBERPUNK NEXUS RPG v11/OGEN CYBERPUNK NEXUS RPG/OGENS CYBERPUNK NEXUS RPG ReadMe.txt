...
- **Companions**: View companion stats (Health, Strength, Influence, Class)
...
Events are based on a D10+D10 roll mapped to 1–100 outcomes:
- D10: 1–10, D10: 1–10
- Outcome = Die1 + Die2 - 1
...
- **Influence**: Enhances strategic outcomes
...
- **Nano Patches**: Restores +25 player health (max 200 + level*10), +20 companion health (max 100). Found in **Neon Underdistrict** (e.g., roll 4: "You slip past drones, finding a Nano Patch in a stash"), **Data Vault** (e.g., roll 19: "You tap a hidden datastream, gaining a Nano Patch"), **Grid Wastelands** (e.g., roll 27: "You stabilize a glitched node, gaining a Nano Patch").
- **Data Drives**: Grants +20 score when used. Found in **Corporate Skyspire** (e.g., roll 13: "You trade with a rogue exec, gaining a Data Drive"), **Data Vault** (e.g., roll 23: "You broker a deal with a vault AI, gaining a Data Drive"), **Grid Wastelands** (e.g., roll 35: "You gain a nomad’s trust, earning a Data Drive").
- **Neon Keys**: Grants +4 crypto chips when used. Found in **Neon Underdistrict** (e.g., roll 11: "You bribe a street fixer, earning a Neon Key"), **Data Vault** (e.g., roll 22: "You take down a vault drone, claiming a Neon Key"), **Grid Wastelands** (e.g., roll 29: "You bypass scavenger traps, securing a Neon Key").
- **Quantum Cores**: Doubles score for the next event; grants +5 score if no score gain. Found in **Neon Underdistrict** (e.g., roll 6: "You fry a rival gang’s server, snagging a Quantum Core"), **Corporate Skyspire** (e.g., roll 21: "You raid a corp vault, securing a Quantum Core"), **Data Vault** (e.g., roll 30: "You fry a vault netrunner, claiming a Quantum Core"), **Grid Wastelands** (e.g., roll 40: "You override a wasteland grid, claiming a Quantum Core").
- **Crypto Chips**: Found in **Neon Underdistrict** (e.g., roll 1: "You hack a street terminal, snagging a Crypto Chip"), **Corporate Skyspire** (e.g., roll 16: "You slice a corporate firewall, uncovering a Crypto Chip"), **Data Vault** (e.g., roll 45: "You slip through a vault network, finding a Crypto Chip"), **Grid Wastelands** (e.g., roll 51: "You hack a ruined terminal, gaining a Crypto Chip").
...
- **RNG Method**: D10+D10 rolls (D10: 1–10, D10: 1–10) mapped to 1–100
